...
// }))
// 1  Log kaydının boyutu 556 bayttır
...
app.use('/documents/swagger', swaggerUi.serve, swaggerUi.setup(swaggerJson, { swaggerOptions: { persistAuthorization: true } }))  //swaggerUi.serve sistemi calistir, verilen url de swagger yayını yap.

// visit http://127.0.0.1:8000/documents/swagger/
...
app.all("/", (req, res) => {
	res.send({
        ...
        api: {
            documents: {
              swagger: "https://personnel-api-omega.vercel.app/documents/swagger",
              redoc: "https://personnel-api-omega.vercel.app/documents/redoc",
              json: "https://personnel-api-omega.vercel.app/documents/json",
            },
...
app.use(require("./src/routes/")); // ./src/routes/index
